...
| Result data | native stdout/stderr plumbing, execution-authority artifact bundle, and bounded local response stream implemented; broker composition/control sink/upload remain | native stdout/stderr plumbing and bounded artifacts accessed under execution authority |
