...
import (
	...
	"github.com/eldenizfamilyanskicode/agent-workstation-gateway/internal/platform/linux/uninstaller"
...
func runUninstall(ctx context.Context, args []string, stdout io.Writer, stderr io.Writer, sourceSHA string) int {
	...
	if executableErr != nil || absoluteErr != nil || platformpath.Contains(platformpath.Linux, *installationRoot, filepath.Clean(absoluteExecutable)) {
